...
/**
 * Padding presets for PixelSurface
 */
export type PixelSurfacePadding = "none" | "xs" | "sm" | "md" | "lg" | number;
 ...
 */
const PADDING_VALUES: Record<Exclude<PixelSurfacePadding, number>, number> = {
  none: 0,
  xs: SPACING.xs,
  sm: SPACING.sm,
  md: SPACING.md,
...
/**
 * PixelSurface - A reusable 9-sliced pixel art container component
 *
 ...
 * @example
 * ```tsx
 * <PixelSurface tintColor="#8B5CF6" padding="md">
 *   <Text>Content inside pixel surface</Text>
 * </PixelSurface>
 *
 * <PixelSurface tintColor="#000000" padding={16} style={{ width: 200, height: 100 }}>
 *   <Text>Fixed size surface</Text>
 * </PixelSurface>
 * ```
 */
export const PixelSurface: React.FC<PixelSurfaceProps> = React.memo(
  ({
    tintColor = "#8B5CF6",
    padding = "md",
    opacity = 1,
